...
export default function SkillsShowcase() {
  ...
  const skills: Skill[] = [
    ...
    },
    {
      ...
      icon: <Server />,
      description:
        "Building full-stack React applications with SSR and API routes",
      category: "frontend",
    ...
    },
    {
      ...
      icon: <Terminal />,
      description:
        "Leveraging AI capabilities for content generation and editing",
      category: "tools",
      color: "from-green-500 to-emerald-600",
    },
  ...
  return (
    ...
    >
      {/* Background sparkles - MODIFIED: Added pointer-events-none */}
      ...
      {/* MODIFIED: Added pointer-events-auto to ensure all elements can receive events */}
      <motion.div
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pointer-events-auto"
        style={{ y }}
      >
        {/* Section header */}
        <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredSkills.map((skill, index) => (
            ...
            >
              {/* MODIFIED: Changed to div wrapper with group class for more reliable hover effects */}
              <div className="relative h-full rounded-xl p-0.5 transition-all duration-300 group overflow-hidden hover:bg-gradient-to-br hover:from-indigo-500 hover:to-purple-600">
                <div className="h-full bg-black rounded-xl p-6 relative overflow-hidden">
                  {/* Background gradient that appears on hover */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${skill.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none`}
                  ></div>

                  {/* Skill header */}
                  <div className="flex items-start mb-4">
                    <div
                      className={`p-2 rounded-lg bg-gradient-to-br ${skill.color} text-white mr-4`}
                    >
                      {skill.icon}
                    </div>
                    <div>
        ...
        {/* Current focus areas */}
        <motion.div
          className="mt-16 bg-black/30 rounded-2xl border border-indigo-500/20 backdrop-blur-sm p-8 pointer-events-auto"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-gray-300 text-sm">
                Specializing in Next.js 14, React, and Tailwind CSS to create
                dynamic, responsive interfaces for both web and mobile
                experiences. Using TypeScript for type-safe development.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-300 text-sm">
                Connecting frontend experiences with backend systems using
                PostgreSQL, Prisma, and cloud functions. Creating seamless data
                flows from database to user interface.
              </p>
            </div>
          </div>
        </motion.div>
